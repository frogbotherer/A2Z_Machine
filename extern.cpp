...
// zscii == 
unsigned char zscii2cp437[69] = {
  0x84, 0x94, 0x81, 0x8e, 0x99, 0x9a, 0xe0, 0xaf, // ae >>
  0xae, 0x89, 0x8b, 0x98, 'E', 'I', 0xa0, 0x82,  // << e/
  0xa1, 0xa2, 0xa3, 'y', 'A', 'E', 'I', 'O', // i/ O/
  'U', 'Y', 0x85, 0x8a, 0x8d, 0x95, 0x97, 'A', // U/ A.
  'E', 'I', 'O', 'U', 0x83, 0x88, 0x8c, 0x93, // E. o^
  0x96, 'A', 'E', 'I', 'O', 'U', 0x86, 0x8f, // u^ Ao
  '0', '0', 'a', 0xa4, 'o', 'A', 0xa5, 'O', // 0 O~
  0x91, 0x92, 0x87, 0x80, 't', 't', 'T', 'T', // ae eth
  0x9c, 'o', 'O', 0xad, 0xa8 // L !?
};
